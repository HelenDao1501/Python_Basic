...
#Function that we'll use to find the specific field.
...
#P2: Insert Data by xml_data
#Get data then parsed it
data_source = open("tracks/Library.xml")
data = data_source.read()
xml_data = ET.fromstring(data)

#Obtain every tag with track data
tracks_data = xml_data.findall("dict/dict/dict")

#Get the values of fields where we like to insert
